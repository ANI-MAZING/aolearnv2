...
const HeroSection = () => {
    return (
            ...
            <motion.div className="w-full flex mt-[100px] flex-col items-center justify-center gap-20">
                <div className="flex justify-center items-center flex-col gap-4">
                    <a href="https://thecodingco.in">
                        <button className="relative px-5 bg-zinc-800 border border-zinc-700 py-1 rounded-full text-xs shadow-2xl overflow-hidden">
      ...
      <iframe className="rounded-lg w-[800px] h-[500px] mx-2 my-4" 
