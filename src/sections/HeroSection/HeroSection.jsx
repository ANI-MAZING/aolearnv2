...
const HeroSection = () => {
    return (
        ...
        >
            {/* Abstract Shapes */}
            <div className="absolute rounded-[30%_70%_70%_30%/30%_61%_39%_70%] blur-[10px] z-[-2] animate-abstractShapeAnimation bg-gradient-to-r from-orange-700 to-orange-400 w-[30%] h-[25%] top-[30%] left-[1%]" />
            ...
            <div className="absolute rounded-[30%_70%_70%_30%/30%_61%_39%_70%] blur-[10px] z-[-2] animate-abstractShapeAnimation bg-gradient-to-r from-orange-700 to-orange-400 w-[30%] h-[25%] top-[30%] left-[70%]" />
            ...
            <motion.div className="w-full flex mt-[100px] flex-col items-center justify-center gap-20">
                ...
                <button className="relative px-8 bg-transparent py-4 rounded-full font-medium text-xs md:text-sm shadow-2xl overflow-hidden shimmer-border">
                    <span className='flex items-center justify-center gap-3 text-white'>
                        Get Started <FaChevronRight className='text-orange-700 text-lg' />
                    </span>
                </button>
